...
# --- Client 1's Private Data (n_k = 2) ---
# (Points are around y = 2x + 1)
MY_DATA = {
    'x': np.array([1.0, 2.0]), 
    'y': np.array([3.0, 5.0])
}
...
def handle_train_request():
    ...
    try:
        ...
        print(f"\n[Client 1] Received /train request.")
...
if __name__ == "__main__":
    # This client will run on port 5001
    # (The Server will be 5000, and Client 2 will be 5002)
